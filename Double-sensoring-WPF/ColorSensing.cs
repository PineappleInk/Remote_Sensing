...
namespace Microsoft.Samples.Kinect.BodyBasics
{
    class ColorSensing
    {
        ...
        public List<double> biglist = new List<double>();
        ...
        public List<double> createBigList(List<int> rödapixlar, List<int> grönapixlar, List<int> blåapixlar)
        {
            // Grön / (Röd + Blå)
            ...
            if (biglist.Count == 0)
            {
                biglist.Add(new double());
            }

            biglist.Add(gDrAverage);
